...
| `metta.catalog.add(S.deprecated(name, since, remedy))` | warn at callable doors and carry the same retirement into explain | `metta.catalog.add(S.deprecated(S.old, S['0.2.0'], S.use(S.new)))` |
