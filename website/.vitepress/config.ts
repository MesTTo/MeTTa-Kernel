...
export default defineConfig({
  ...
  themeConfig: {
    nav: [
      ...
      { text: "PeTTorch", link: "/pettorch/tensors" },
    ...
    sidebar: [
      ...
      },
      {
        text: "PeTTorch",
        items: [
          { text: "Tensors", link: "/pettorch/tensors" },
          { text: "MettaModule", link: "/pettorch/metta-module" },
          { text: "Training", link: "/pettorch/training" },
          { text: "Reflection", link: "/pettorch/reflection" },
        ],
      },
      {
        text: "Reference",
        ...
        items: [
          ...
          { text: "pettorch", link: "/reference/pettorch" },
          { text: "pettorch.tensors", link: "/reference/pettorch-tensors" },
          { text: "pettorch.modules", link: "/reference/pettorch-modules" },
          { text: "pettorch.train", link: "/reference/pettorch-train" },
          { text: "pettorch.reflect", link: "/reference/pettorch-reflect" },
          { text: "pettorch.neural", link: "/reference/pettorch-neural" },
          { text: "pettorch.knn", link: "/reference/pettorch-knn" },
        ],
      },
    ],
