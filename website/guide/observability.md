...
| how was this answer derived? | [`petta.derivation`](../reference/petta-derivation): `Derivation`, `Step`, `Fact` proof trees |
...
| what did this evaluation do, step by step? | [`petta.trace`](../reference/petta-trace), the reduction trace as events |
...
| what is silently wrong in this space? | [`petta.lint`](../reference/petta-lint); `lint_file(path)` anchors each finding to its `file:line` |
