...
%
%WHAT IT COVERS: NARROWING in constructive negation's sense, a variable's
...
%extensions/python/tests/conformance/test_metatheory.py exists to keep out of the tree. (= (has-child $x) (match &self (parent $x $y) True))
