...
```sh
swipl-ld -shared -o examples/integration/c_extension/cbump \
                    examples/integration/c_extension/cbump.c
sh run.sh examples/integration/c_extension/c_extension.metta
```
...
```sh
swipl-ld -shared -o examples/integration/c_extension/handle \
                    examples/integration/c_extension/handle.c
sh run.sh examples/integration/c_extension/handle.metta
```
