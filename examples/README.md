...
The merged corpus contains 233 examples that run in the shell suite.
...
143 of the 251 programs here derive from the MeTTa examples of the project at
...
108 examples were written for this repository.
