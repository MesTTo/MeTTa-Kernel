...
MORK is one of these and used to be none of it. Its `morkspaces.pl` was written
by path into `engine/metta.pl`'s load list, in a second copy of that list behind
