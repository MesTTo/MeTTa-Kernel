...
%   - repr presents a value by its default reading, host repr for an object
%     and the structural MeTTa text for a converted tuple [tested:
...
%     beside it, in extensions/python/tests/ch11_python_as_a_notation/test_ops.py
...
% door is extensions/python/tests/ch11_python_as_a_notation/test_ops.py,
