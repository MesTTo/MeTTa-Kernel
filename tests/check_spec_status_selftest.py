...
FILES = {
    ...
    "python/tests/test_preexisting.py": "def test_preexisting():\n    assert True\n",
...
| **P90.5** | cover it in the fast tier's own suite | see item | `python/tests/test_preexisting.py` covers it | X1 |
